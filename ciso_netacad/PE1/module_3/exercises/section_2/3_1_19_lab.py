...
if input("Enter the name of a plant: ") == "Spathiphyllum":
    print("Yes - Spathiphyllum is the best plant ever!")
elif input("Enter the name of a plant: ") == "spathiphyllum":
    print("No, I want a big Spathiphyllum!")
else:
    print("Spathiphyllum! Not " + input("Enter the name of a plant: ") + "!")
